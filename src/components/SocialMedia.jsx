...
const PosterShowcase = () => {
    ...
    <p className="text-base leading-snug tracking-tight">
        <span className="font-bold">Produced 35+ visual assets (posters & Reels)</span>{' '}
        for BAZMA, SMK, and Puskesmas project accounts, and was fully responsible for{' '}
        <span className="font-bold">managing special publications (posts)</span>{' '}
        on{' '}
        <span className="font-bold">SMK social media accounts</span>.
    </p>
</div>
                </div>
